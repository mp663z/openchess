...
LOCAL_ROWS = {
    ...
    "rollback": [
        ...
        {
            "name": "local-king-move-as-castle-with-suffix",
            "scenario_tag": "castling:king-move-notation-suffixed",
            "san": "Kc1+",
            "state": _CASTLE,
            "expect_failure": "no_legal_match",
        },
...
EXPECTED_KILLS = {
    ...
    "nearest-move-fallback": [
        ...
        "local-king-move-as-castle-with-suffix",
        "local-mate-claimed-as-check",
        "local-mate-missing-suffix",
    ],
    ...
    "castling-without-rook-hop": ["castling-rook-hop-check", "local-check-missing-suffix"],
    "emit-mate-as-check": ["local-mate-suffix"],
    "resolve-strips-whitespace": ["local-leading-space", "local-trailing-space"],
    "suffix-optional": ["local-check-missing-suffix", "local-mate-missing-suffix"],
    ...
    "king-move-as-castle": ["local-king-move-as-castle", "local-king-move-as-castle-with-suffix"],
}
