...
def _m(name, bad, fix):  # noqa: C901 - one closed branch per tag
    ...
    if name == "request_not_a_dict":
        ...
        paths = [("previous", k) for k in bad_vals] + [("previous", "limit_id")]
...
FIXTURE_EDITS = {
    ...
    "prev-capacity-bound-plus": (
        '_int_in(prev["capacity"], 1, _REF_MAX_CAPACITY)',
        '_int_in(prev["capacity"], 1, _REF_MAX_CAPACITY + 1)',
    ),
