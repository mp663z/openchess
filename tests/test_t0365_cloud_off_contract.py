...
def _set(s, mode, rev, iid=INS, opt_in="bound"):
    if opt_in == "bound":
...
def _hostile_rows():
    ...
    for dest in ("Cloud", "remote", "", "cloud ", None, True):
...
# No equivalent one-edit mutant was found; every edit listed above is red.
_SELF = Path(__file__)
