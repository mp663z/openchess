...
def close_envelope(doc, *, contract_id, sections,
    ...
    if set(cc) != set(sections):
        raise ContractError(
            ...
            f"missing={sorted(set(sections) - set(cc))} "
            f"extra={sorted(set(cc) - set(sections))}")
    return cc
