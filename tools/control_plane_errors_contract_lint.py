...
PINS = {
    ...
    "request": {
        "arguments": ["source", "status", "payload"],
    ...
    "result": {
        ...
        "privacy": "no-write-only-key-material-or-chess-content-in-error-message-or-extra-fields",
    ...
    "readings": {
        ...
        "reference": "tools/contract_conformance.py-validates-status-and-declared-error-field-types-while-t0419-owns-status-grouping-do-not-copy-its-code-status-table",
    },
    "semantics": {
