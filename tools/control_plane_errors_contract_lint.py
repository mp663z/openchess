...
PINS = {
    ...
    "result": {
        ...
        "privacy": "declared-success-response-fields-are-exempt-from-secret-name-check-only-undeclared-success-extras-and-all-error-fields-use-full-secret-name-check-chess-and-structural-checks-always-apply",
