...
PINS = {
    ...
    "result": {
        ...
        "privacy": "chess-content-checks-key-tokens-and-fen-values-apply-to-every-response-secret-name-checks-apply-to-all-but-declared-fields-short-san-move-text-and-key-shaped-values-remain-gaps-token-run-32-applies-to-errors",
    ...
    "readings": {
        ...
        "fen": "every-response-string-value-refused-if-any-substring-at-any-start-and-end-offset-is-valid-eight-rank-placement-linear-time-no-edge-exclusions-derived-from-fen-yaml",
        "token_run": "error-response-string-values-and-keys-including-nested-refused-for-32-or-more-contiguous-[A-Za-z0-9+/=_%-]-characters-short-san-remains-an-owner-gap",
