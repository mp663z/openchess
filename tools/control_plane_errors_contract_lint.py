...
PINS = {
    ...
    "result": {
        ...
        "privacy": "declared-success-response-fields-are-exempt-only-from-secret-name-check-key-name-camelcase-token-secret-name-in-message-and-fen-value-checks-apply-to-error-path-san-move-text-and-key-shaped-values-are-stated-gaps",
    ...
    "readings": {
        ...
        "fen": "error-path-string-values-checked-for-eight-rank-piece-placement-derived-from-data-contracts-fen-yaml-not-a-copied-grammar",
