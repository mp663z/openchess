...
PINS = {
    ...
    "compatibility": {
        ...
        "allowlists": "public-and-read-only-lists-are-sets-in-meaning-new-list-equals-old-list-plus-exactly-new-operations-with-matching-auth-and-mutating-no-duplicates-existing-membership-immutable-order-insignificant",
        ...
        "new_area_reading": "coordinator-ruling-new-area-with-new-operations-is-a-minor-addition-under-control-plane-line-14",
