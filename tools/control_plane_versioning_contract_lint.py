...
PINS = {
    ...
    "source": {
        ...
        "scheme": "semver",
        "source_structure": "control-plane-schema-v2-validated-by-the-linked-contract-lint-with-additive-comparison-of-operations-and-fields",
    },
    "request": {
    ...
    "compatibility": {
        ...
        "reading": "control-plane.yaml lines 13-19: MINOR is additive-only followed by a closed list; a new response field is optional because servers MUST accept any client minor within its major; optional-to-required is not in the list and needs a new MAJOR base path. The same applies to optional request fields. Rollback permits extras, not guaranteed presence.",
