...
SEMANTICS = {
    ...
    "history": "every-applied-transition-records-its-prior-value",
}
PROPERTIES = {
    ...
    "rollback": "rollback-restores-the-prior-value-under-the-same-transition-rules",
}
VERSIONING = {
...
FAILURE_TRIGGERS = {
    "malformed_flag_request": (
        "request-grammar-or-exact-type-violation-including-"
        "str-dict-list-subclasses-and-int-for-bool"
    ),
